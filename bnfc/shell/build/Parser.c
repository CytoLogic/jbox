...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL__LT = 6,                        /* _LT  */
  YYSYMBOL__GT = 7,                        /* _GT  */
  YYSYMBOL__BAR = 8,                       /* _BAR  */
  YYSYMBOL_T_Word = 9,                     /* T_Word  */
  YYSYMBOL_YYACCEPT = 10,                  /* $accept  */
  YYSYMBOL_ListJob = 11,                   /* ListJob  */
  YYSYMBOL_Input = 12,                     /* Input  */
  YYSYMBOL_Job = 13,                       /* Job  */
  YYSYMBOL_CommandLine = 14,               /* CommandLine  */
  YYSYMBOL_Pipeline = 15,                  /* Pipeline  */
  YYSYMBOL_ListWord = 16,                  /* ListWord  */
  YYSYMBOL_CommandPart = 17,               /* CommandPart  */
  YYSYMBOL_OptRedir = 18                   /* OptRedir  */
};
...
{
       0,   125,   125,   126,   128,   130,   131,   133,   135,   136,
...
static const char *const yytname[] =
{
  ...
  "_SEMI", "_LT", "_GT", "_BAR", "T_Word", "$accept", "ListJob", "Input",
  "Job", "CommandLine", "Pipeline", "ListWord", "CommandPart", "OptRedir", YY_NULLPTR
};
...
{
       0,    10,     4,     0,     2,     5,    13,    12,     8,    11,
       1,     0,     6,     0,     0,     7,     0,     3,    17,    16,
       9,     0,     0,    14,    15
};
...
{
      13,    14,     1,    10,    11,    12,    16,    17,    20,    18,
      22,    19,    21,     9,     0,    23,    24
};

static const yytype_int8 yycheck[] =
{
       6,     7,     9,     0,     5,     4,     8,    11,    16,     9,
       6,     9,     7,     1,    -1,     9,     9
};
...
{
       0,     9,    11,    12,    13,    14,    15,    16,    17,    16,
       0,     5,     4,     6,     7,    18,     8,    11,     9,     9,
      15,     7,     6,     9,     9
};
...
#line 1278 "Parser.c"
  ...
  case 3: /* ListJob: Job _SEMI ListJob  */
#line 126 "Grammar.y"
                      { (yyval.listjob_) = make_ListJob((yyvsp[-2].job_), (yyvsp[0].listjob_)); }
#line 1284 "Parser.c"
    break;

  case 4: /* Input: ListJob  */
#line 128 "Grammar.y"
                { (yyval.input_) = make_StartInput((yyvsp[0].listjob_)); result->input_ = (yyval.input_); }
#line 1290 "Parser.c"
    break;

  case 5: /* Job: CommandLine  */
#line 130 "Grammar.y"
                  { (yyval.job_) = make_FGJob((yyvsp[0].commandline_)); }
#line 1296 "Parser.c"
    break;

  case 6: /* Job: CommandLine _AMP  */
#line 131 "Grammar.y"
                     { (yyval.job_) = make_BGJob((yyvsp[-1].commandline_)); }
#line 1302 "Parser.c"
    break;

  case 7: /* CommandLine: Pipeline OptRedir  */
#line 133 "Grammar.y"
                                { (yyval.commandline_) = make_CmdLine((yyvsp[-1].pipeline_), (yyvsp[0].optredir_)); }
#line 1308 "Parser.c"
    break;

  case 8: /* Pipeline: CommandPart  */
#line 135 "Grammar.y"
                       { (yyval.pipeline_) = make_SingleCmd((yyvsp[0].commandpart_)); }
#line 1314 "Parser.c"
    break;

  case 9: /* Pipeline: CommandPart _BAR Pipeline  */
#line 136 "Grammar.y"
                              { (yyval.pipeline_) = make_PipeCmd((yyvsp[-2].commandpart_), (yyvsp[0].pipeline_)); }
#line 1320 "Parser.c"
    break;

  case 10: /* ListWord: T_Word  */
#line 138 "Grammar.y"
                  { (yyval.listword_) = make_ListWord((yyvsp[0]._string), 0); }
#line 1326 "Parser.c"
    break;

  case 11: /* ListWord: T_Word ListWord  */
#line 139 "Grammar.y"
                    { (yyval.listword_) = make_ListWord((yyvsp[-1]._string), (yyvsp[0].listword_)); }
#line 1332 "Parser.c"
    break;

  case 12: /* CommandPart: ListWord  */
#line 141 "Grammar.y"
                       { (yyval.commandpart_) = make_Cmd((yyvsp[0].listword_)); }
#line 1338 "Parser.c"
    break;

  case 13: /* OptRedir: %empty  */
#line 143 "Grammar.y"
                       { (yyval.optredir_) = make_NoRedir(); }
#line 1344 "Parser.c"
    break;

  case 14: /* OptRedir: _LT T_Word _GT T_Word  */
#line 144 "Grammar.y"
                          { (yyval.optredir_) = make_InOutRedir((yyvsp[-2]._string), (yyvsp[0]._string)); }
#line 1350 "Parser.c"
    break;

  case 15: /* OptRedir: _GT T_Word _LT T_Word  */
#line 145 "Grammar.y"
                          { (yyval.optredir_) = make_OutInRedir((yyvsp[-2]._string), (yyvsp[0]._string)); }
#line 1356 "Parser.c"
    break;

  case 16: /* OptRedir: _GT T_Word  */
#line 146 "Grammar.y"
               { (yyval.optredir_) = make_OutRedir((yyvsp[0]._string)); }
#line 1362 "Parser.c"
    break;

  case 17: /* OptRedir: _LT T_Word  */
#line 147 "Grammar.y"
